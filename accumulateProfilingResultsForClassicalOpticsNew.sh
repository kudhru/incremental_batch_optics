...
fileName=ProfilingResults/Profiling_result\[classical_$dataFile\_$noOfPartitions\_$windowSize\_0_$startPartition\].txt
outputFileName=AccumulatedProfResults/ProfilingResults_classical_Addition_$dataFile\_$noOfPartitions\_$windowSize.txt
echo "$fileName"
...
# echo "$fileName"
# ./mainTime $fileName $outputFileName 1
fileName=ProfilingResults/Profiling_result\[classical_$dataFile\_$noOfPartitions\_$windowSize\_1_$startPartition\].txt
#outputFileName=AccumulatedProfResults/ProfilingResults_batchwise_Deletion_$dataFile\_$noOfPartitions\_$windowSize.txt
echo "$fileName"
./mainTime $fileName $outputFileName 1
 startPartition=`expr $startPartition + 1`
